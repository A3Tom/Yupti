"""
    This repository is based off of the code samples provided by the AWS SDK team and can be found here
...
class CognitoIdentityProviderWrapper:
    ...
    def confirm_sign_up(self, user_name, confirmation_code):
        ...
        try:
            ...
            print(
                "Couldn't confirm %s. Here's why: %s: %s",
                user_name,
                err.response["Error"]["Code"],
                err.response["Error"]["Message"],
            )
